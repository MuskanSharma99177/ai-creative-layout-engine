    ...
    <aside className="w-80 lg:w-96 bg-slate-900 border-l border-slate-800 flex flex-col h-[calc(100vh-4rem)] select-none">
      ...
      <div className="p-4 border-b border-slate-800 flex items-center justify-between">
        ...
        >
          ...
          {engineMode === 'ai-gemini' ? 'Gemini AI' : 'Rule Engine'}
        </span>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 lg:p-5 space-y-6 custom-scrollbar text-slate-300 text-xs">
        ...
        <div className="bg-slate-950/80 rounded-2xl border border-slate-800 p-4 space-y-3.5 shadow-md">
          <div className="flex items-center gap-2 text-purple-400 font-semibold text-xs border-b border-slate-800/80 pb-2">
